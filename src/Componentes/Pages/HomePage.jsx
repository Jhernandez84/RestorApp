...
export const HomePage = () =>{
    return (
        ...
        <div className="container contenedorVideoInicio">
        <VideoIntro/>
            ...
            <img className="col-md-6 float-md-end mb-3 ms-md-3" src="https://media.istockphoto.com/id/163807674/es/foto/cocina-internacional.jpg?s=612x612&w=0&k=20&c=vzVod_CFpXt5-67UqY4cvxsletYkPkwUIN8fHA5M5Jo=" alt="" />
